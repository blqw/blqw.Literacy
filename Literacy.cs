...
namespace blqw
{
    ...
    public class Literacy : ILoadMember
    {
        ...
        public static LiteracyNewObject CreateNewObject(Type type, Type[] argTypes = null)
        {
            ...
            if (type.IsValueType)
            {
                var dm = new DynamicMethod("", TypeObject, TypesObjects, type.IsArray ? typeof (Array) : type);
        ...
        public static LiteracyGetter CreateGetter(PropertyInfo prop)
        {
            ...
            var dm = new DynamicMethod("", TypeObject, TypesObject, prop.DeclaringType);
            var il = dm.GetILGenerator();
        ...
        public static LiteracyGetter CreateGetter(FieldInfo field)
        {
            ...
            var dm = new DynamicMethod("", TypeObject, TypesObject, field.DeclaringType);
            var il = dm.GetILGenerator();
            if (field.IsStatic)
            {
        ...
        public static LiteracySetter CreateSetter(PropertyInfo prop)
        {
            ...
            var dm = new DynamicMethod("", null, Types2Object, prop.DeclaringType);
        ...
        public static LiteracySetter CreateSetter(FieldInfo field)
        {
            ...
            var dm = new DynamicMethod("", null, Types2Object, field.DeclaringType);
            var il = dm.GetILGenerator();
        ...
        public static LiteracyCaller CreateCaller(MethodInfo method)
        {
            ...
            var dm = new DynamicMethod("", TypeObject, TypesObjectObjects, method.DeclaringType);
